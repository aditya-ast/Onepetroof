          ...
          <div className="relative">
            <div className="lg:w-2/3">
              <p className="text-sm font-normal tracking-widest text-gray-300 uppercase" style={{ fontFamily: "Montserrat" }}>
                Welcome to the Pet friendly Hotels of Onepetroof
              </p>
              ...
              <p className="max-w-lg mt-4 text-l font-normal text-gray-400 sm:mt-8">
                 Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ex enim similique, distinctio architecto odit debitis modi facilis maxime rerum perferendis voluptatem, corporis a voluptates ipsum natus, culpa dolores ea et!
              </p>
