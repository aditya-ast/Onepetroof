          ...
          <div className="relative">
            <div className="lg:w-2/3">
              <p className="text-sm font-normal tracking-widest text-gray-300 uppercase" style={{ fontFamily: "Montserrat" }}>
                Welcome to the Blog of Onepetroof
              </p>
              ...
              <p className="max-w-lg mt-4 text-l font-normal text-gray-400 sm:mt-8">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ab dolores eveniet voluptas excepturi obcaecati! Repudiandae corrupti dignissimos corporis consectetur expedita commodi fugit cupiditate deserunt blanditiis exercitationem maiores, rerum facilis mollitia.
              </p>
